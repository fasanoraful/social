        ...
        if (submitable) {
            ...
            $.ajax({
                ...
                error: function() {
                    ...
                    NextPost.DisplayFormResult($form, "error", __("Opa! Um erro ocorreu. Por favor, tente novamente mais tarde!"));
                },

                success: function(resp) {
                    // console.log(resp); // retorno de login 
...
NextPost.Alert = function(data = {}) {
    data = $.extend({}, {
        title: __("Error"),
        content: __("Opa! Um erro ocorreu. Por favor, tente novamente mais tarde!"),
...
NextPost.Statistics = function() {
    ...
    $.ajax({
        ...
        error: function() {
            $account_summary.find(".numbers").html("<div class='error'>" + __("Opa! Um erro ocorreu. Por favor, tente novamente mais tarde!") + "</div>");
    ...
    $form.find(".resend-btn").on("click", function() {
        ...
        $.ajax({
            ...
            error: function() {
                ...
                $parent.find(".resend-result").html(__("Opa! Um erro ocorreu. Por favor, tente novamente mais tarde!")).removeClass('none');
            },
...
NextPost.Profile = function() {
    $(".js-resend-verification-email").on("click", function() {
        ...
        $.ajax({
            ...
            error: function() {
                $this.remove();
                $alert.find(".js-resend-result").html(__("Opa! Um erro ocorreu. Por favor, tente novamente mais tarde!"));
